...
let resetButton = document.querySelector("#reset-button"); // Ensure this button exists in your HTML
let msgContainer = document.querySelector(".msg-container");
let msg = document.querySelector("#msg");
let boxes = document.querySelectorAll(".box"); // Ensure each box has a class "box"

let turnO = true; // Tracks if it's 'O' turn (otherwise, it's 'X')
let boxCount = 0;
let gameWon = false;
